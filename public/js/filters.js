document.addEventListener("DOMContentLoaded", function () {
    let e = "number" == typeof window.__CURRENT_PAGE ? window.__CURRENT_PAGE : 1,
        ...
        n = i.length > 0,
        r = !!window.__HAS_MORE_PAGES,
        a = r,
        o = {};
    const s = "function" == typeof window.matchMedia ? window.matchMedia("(max-width: 768px)") : null;
    let l = s && s.matches ? 1 : 1 / 0,
        d = null;
    function c(e) {
        if (!e || "true" === e.dataset.deferredLoaded) return;
        const t = e.getAttribute("data-src");
        t && ((e.src = t), (e.dataset.deferredLoaded = "true"), e.removeAttribute("data-src"));
    }
    function p(e) {
        const t = (e && e.querySelectorAll ? e : document).querySelectorAll(".deferred-image");
        t.length &&
                      ...
                      (d = new IntersectionObserver(
                          function (e) {
                              e.forEach(function (e) {
                                  ...
                                  const t = e.target;
                                  d.unobserve(t), delete t.dataset.deferredObserving, c(t);
                              });
                          },
                          { rootMargin: "200px 0px", threshold: 0.01 }
                      )),
                  t.forEach(function (e) {
                      "true" !== e.dataset.deferredLoaded &&
                          "true" !== e.dataset.deferredObserving &&
                          ((e.dataset.deferredObserving = "true"), d.observe(e));
                  }))
                : t.forEach(c));
    }
    function g() {
        const e = document.querySelector(".girlsSection");
        e && "function" == typeof e.scrollIntoView && e.scrollIntoView({ behavior: "smooth", block: "start" });
    }
    function u(e) {
        if (!e) return;
        const t = e.querySelectorAll(".girlCard");
        if (!s || !s.matches)
            return (
                (l = 1 / 0),
                void t.forEach(function (e) {
                    e.classList.remove("is-mobile-hidden", "mobile-hidden-default");
                })
            );
        const i = Array.from(t).filter(function (e) {
            return !e.classList.contains("is-mobile-hidden") && !e.classList.contains("mobile-hidden-default");
        }).length;
        0 === i && (!Number.isFinite(l) || l < 1) ? (l = 1) : i > l && (l = i),
            t.forEach(function (e, t) {
                t < l
                    ? e.classList.remove("is-mobile-hidden", "mobile-hidden-default")
                    : e.classList.add("is-mobile-hidden", "mobile-hidden-default");
            });
    }
    function h(e) {
        (l = e.matches ? 1 : 1 / 0), u(document.querySelector(".girlsSection"));
    }
    function f() {
        document.querySelectorAll('.girlCard--skeleton[data-skeleton="append"]').forEach((e) => e.remove());
    }
    (window.observeDeferredImages = p),
        p(document),
        s &&
            ("function" == typeof s.addEventListener
                ? s.addEventListener("change", h)
                : "function" == typeof s.addListener && s.addListener(h));
    const v = document.querySelector(".more-info");
    n || r || !v || (v.style.display = "none");
    let m = null;
    function w(e, t) {
        const i = document.getElementById(e);
        if (!i || !Array.isArray(t) || "true" === i.dataset.populated) return;
    ...
    function C() {
        ...
        (t.className = "girls-loader"),
            (t.innerHTML = '<div class="spinner"></div><p>Загрузка...</p>'),
            e.insertAdjacentElement("beforebegin", t);
    }
    function y() {
        const e = document.querySelector(".girls-loader");
        e && ((e.style.opacity = "0"), (e.style.transition = "opacity 0.3s"), setTimeout(() => e.remove(), 300));
    }
    function k(d, c = !1) {
        if (t) return;
        (t = !0),
            c
                ? (C(),
                  (function (e = 4) {
                      const t = document.querySelector(".girlsSection");
                      if (!t) return;
                      f();
                      let i = "";
                      for (let t = 0; t < e; t++)
        ...
        const p = c ? o : b();
        p.page = d;
        const g = localStorage.getItem("selectedCity") || "moscow";
        p.city = g;
        const h = new URLSearchParams(p).toString();
        fetch("/?" + h, {
            method: "GET",
            ...
            .then((o) => {
                c
                    ...
                    : (!(function (e) {
                          const t = document.querySelector(".girlsSection");
                          if (!t) return;
                          if ((f(), (i = []), (n = !1), 0 === e.length))
                              t.innerHTML =
                                  '<div class="no-results"><p>По вашему запросу ничего не найдено. Попробуйте изменить фильтры.</p></div>';
                          else {
                              let i = "";
                              e.forEach((e) => {
                                  i += A(e);
                                  ...
                                  (t.innerHTML = i);
                              const n = t.querySelector(".girlCard");
                              n &&
                                  (n.classList.remove("is-mobile-hidden", "mobile-hidden-default"),
                                  n.setAttribute("data-mobile-initial-hidden", "false"));
                          }
                          s && s.matches && (l = 1);
                          u(t), "function" == typeof window.observeDeferredImages && window.observeDeferredImages(t);
                          document.dispatchEvent(new CustomEvent("girlCards:mutated", { detail: { scope: t } }));
                      })(o.girls),
                      y()),
                    (a = o.hasMore),
                    (e = d);
                const p = document.querySelector(".more-info");
                p && (p.style.display = a ? "block" : "none"),
                    ...
                    c ||
                        (function (e, t) {
                            const i = 20,
                                n = Math.max(1, Math.ceil(t / i)),
                                r = document.querySelector(".paginationGirls");
                            if (!r) return;
                            if (n <= 1) return void (r.style.display = "none");
                            r.style.display = "flex";
                            const a = '<span class="block-paginationGirls" data-ellipsis="true">...</span>',
                                o = (t) =>
                                    `<a href="#!" class="block-paginationGirls${t === e ? " block-paginationGirls__active" : ""}" data-page="${t}">${t}</a>`,
                                s = [];
                            if (n <= 7) for (let e = 1; e <= n; e++) s.push(o(e));
                            else if (e <= 4) {
                                for (let e = 1; e <= 5; e++) s.push(o(e));
                                s.push(a), s.push(o(n));
                            } else if (e >= n - 3) {
                                s.push(o(1)), n > 5 && s.push(a);
                                for (let e = Math.max(2, n - 4); e <= n; e++) s.push(o(e));
                            } else {
                                s.push(o(1)), s.push(a);
                                for (let t = e - 1; t <= e + 1; t++) s.push(o(t));
                                s.push(a), s.push(o(n));
                            }
                            const l = '<img src="/img/arrowLeft.svg" alt="" width="36" height="36" decoding="async">',
                                d = '<img src="/img/arrowNext.svg" alt="" width="36" height="36" decoding="async">',
                                c =
                                    e >= n
                                        ? `<span class="arrowPagination arrowPagination-next" aria-disabled="true" style="opacity: 0.5; cursor: not-allowed;">${d}</span>`
                                        : `<a href="#!" class="arrowPagination arrowPagination-next" aria-label="Следующая страница" data-page="${e + 1}">${d}</a>`,
                                p =
                                    e <= 1
                                        ? `<span class="arrowPagination arrowPagination-prev" aria-disabled="true" style="opacity: 0.5; cursor: not-allowed;">${l}</span>`
                                        : `<a href="#!" class="arrowPagination arrowPagination-prev" aria-label="Предыдущая страница" data-page="${e - 1}">${l}</a>`;
                            r.innerHTML = p + '<div class="pagination__paginationGirls">' + s.join("") + "</div>" + c;
                        })(d, o.total),
                    "function" == typeof window.updateFavoritesAfterLoad && window.updateFavoritesAfterLoad();
            })
            .catch(() => {
                y(), f(), (t = !1), alert("Произошла ошибка при загрузке данных. Попробуйте еще раз.");
            });
    }
    function _(e) {
        const t = document.querySelector(".girlsSection");
        t &&
            ...
            e.forEach((e) => {
                ...
                n && "function" == typeof window.observeDeferredImages && window.observeDeferredImages(n);
            }),
            u(t),
            t && document.dispatchEvent(new CustomEvent("girlCards:mutated", { detail: { scope: t } })));
    }
    function A(e) {
    ...
    document.querySelectorAll(".filtersBtn").forEach((e) => {
        e.addEventListener("click", function (e) {
            e.preventDefault(),
                m ||
                    (m = fetch("/api/filter-options")
                        .then((e) => e.json())
                        .then((e) => {
                            w("hairColorSelect", e.hair_colors),
                                w("intimateTrimSelect", e.intimate_trims),
                                w("nationalitySelect", e.nationalities),
                                w("districtSelect", e.districts),
                                w("regionSelect", e.regions);
                        })
                        .catch(() => {
                            m = null;
                        }));
            const t = document.getElementById("modal__project1");
            t && ((t.style.display = "block"), setTimeout(() => (t.style.opacity = "1"), 10));
        });
    });
    const x = document.querySelector(".close1");
    x &&
        x.addEventListener("click", function () {
            const e = document.getElementById("modal__project1");
            e && ((e.style.opacity = "0"), setTimeout(() => (e.style.display = "none"), 300));
        }),
        window.addEventListener("click", function (e) {
            "modal__project1" === e.target.id &&
                ((e.target.style.opacity = "0"), setTimeout(() => (e.target.style.display = "none"), 300));
        }),
        document.querySelectorAll(".btn-formFilterModal__btn").forEach((t) => {
            t.addEventListener("click", function (t) {
                t.preventDefault(), (e = 1), (o = b());
                const i = document.getElementById("modal__project1");
                i && ((i.style.opacity = "0"), setTimeout(() => (i.style.display = "none"), 300)), k(1, !1);
            });
        }),
        v &&
            v.addEventListener("click", function (o) {
                ...
                if (
                    (function () {
                        ...
                        const i = l;
                        return (l = Math.min(t.length, l + 2)), u(e), l - i;
                    })() > 0
                ) {
                    if (
                        document.querySelectorAll(
                            ".girlsSection .girlCard.is-mobile-hidden, .girlsSection .girlCard.mobile-hidden-default"
                        ).length > 0
                    )
                        return;
                }
                if (n && i.length) return _(i), (i = []), (n = !1), void (r || (this.style.display = "none"));
                a || r ? t || k(e + 1, !0) : (this.style.display = "none");
            }),
        document.addEventListener("click", function (i) {
            const n = i.target.closest(".block-paginationGirls");
            if (n && !n.dataset.ellipsis) {
                i.preventDefault();
                const r = n.textContent.trim();
                if ("..." === r) return;
                const a = parseInt(r);
                isNaN(a) || t || ((e = a - 1), k(a, !1), g());
            }
            const r = i.target.closest(".arrowPagination-next");
            if (r && "true" !== r.getAttribute("aria-disabled")) {
                if ((i.preventDefault(), t || !a)) return;
                k(e + 1, !1), g();
            }
            const o = i.target.closest(".arrowPagination-prev");
            if (o && "true" !== o.getAttribute("aria-disabled")) {
                if ((i.preventDefault(), t || e <= 1)) return;
                k(e - 1, !1), g();
            }
        });
});
