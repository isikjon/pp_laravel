...
class ImportMassageSpb extends Command
{
    protected $signature = 'massage:import-spb {--fresh : Delete existing masseuses from SPB}';
    protected $description = 'Import SPB masseuses from JSON files in parser_xlsx/anketas_massage-spb';
    ...
    public function handle()
    {
        ...
        if ($this->option('fresh')) {
            $this->info('Deleting masseuses from SPB...');
            Masseuse::where('city', 'Санкт-Петербург')->delete();
        }
