...
@section('title', 'Проститутки индивидуалки массажистки ' . getCityNameInCase('genitive'))
    ...
    <section class="mainContent">
        <div class="container">
            ...
            <div class="textSection">
                <h1>
                    Проститутки индивидуалки массажистки {{ getCityNameInCase('genitive') }}
                </h1>
                <p>
...
@section('page_scripts')
    <script>
        ...
        console.log('=== MASSEUSE PAGE DEBUG ===');
        console.log('Selected City:', @json($selectedCity ?? 'moscow'));
        console.log('City Name:', @json($cityName ?? 'Москва'));
        console.log('Current URL:', window.location.href);
        console.log('Current Path:', window.location.pathname);
        console.log('URL Params:', new URLSearchParams(window.location.search).toString());
        
        // Логируем все ссылки пагинации
        document.addEventListener('DOMContentLoaded', function() {
            const paginationLinks = document.querySelectorAll('.paginationGirls a');
