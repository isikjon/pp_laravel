...
@section('title', 'Стрип-клубы в ' . getCityNameInCase('prepositional'))
    ...
    <section class="mainContent">
        <div class="container">
            <div class="textSection">
                <h1>
                    Стрип-клубы в {{ getCityNameInCase('prepositional') }}
                </h1>
                <p>
                    Лучшие стрип-клубы {{ getCityNameInCase('genitive') }} – профессиональные танцовщицы и незабываемые шоу. Посетите наши заведения и насладитесь атмосферой роскоши и страсти.
                </p>
            </div>
