...
@section('title', 'Интим-салоны в ' . (($cityName ?? 'Москва') === 'Санкт-Петербург' ? 'Санкт-Петербурге' : 'Москве'))
    ...
    <section class="mainContent">
        <div class="container">
            <div class="textSection">
                <h1>
                    Интим-салоны в {{ ($cityName ?? 'Москва') === 'Санкт-Петербург' ? 'Санкт-Петербурге' : 'Москве' }}
                </h1>
                <p>
                    Лучшие интим-салоны {{ $cityName === 'Санкт-Петербург' ? 'Санкт-Петербурга' : 'Москвы' }} – профессиональный сервис и высокий уровень обслуживания. В каждом салоне работают красивые и опытные девушки, готовые подарить вам незабываемые моменты наслаждения.
                </p>
            </div>
