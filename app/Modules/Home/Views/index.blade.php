    ...
    <section class="mainContent">
        <div class="container">
            ...
            <div class="textSection">
                <h1>
                    Проститутки в {{ getCityNameInCase('prepositional') }}
                </h1>
                <p>
                    Лучшие проститутки {{ getCityNameInCase('genitive') }} собраны на одном сайте с актуальными ценами и проверенными анкетами. Используйте фильтры, чтобы быстро отфильтровать девушек по услугам, району и бюджету.
                </p>
            </div>
