        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="mb-4">
                ...
                <div class="mt-2 text-sm text-gray-600 dark:text-gray-400 space-y-2">
                    <p><strong>1.</strong> Выберите базу данных (Москва или Санкт-Петербург)</p>
                    <p><strong>2.</strong> Выберите тип ресурса (Girls, Masseuses, Salons, Strip Clubs)</p>
                    <p><strong>3.</strong> Выберите диапазон записей для замены:</p>
                    ...
                    <p><strong>4.</strong> Введите новый номер телефона в формате +7(999)999-99-99</p>
                    <p><strong>5.</strong> Нажмите "Заменить номера" и подтвердите действие</p>
